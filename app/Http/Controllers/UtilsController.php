...
//            $message->to('mihaelamicu.stoian@gmail.com')->subject('Serviciu solicitat din aplicatie');
            $message->to('vctr.dumitru@gmail.com')->subject('Serviciu de salarizare solicitat din aplicatie');
        });
    }
...
//            $message->to('mihaelamicu.stoian@gmail.com')->subject('Serviciu solicitat din aplicatie');
            $message->to('vctr.dumitru@gmail.com')->subject('Serviciu de audit solicitat din aplicatie');
        });
    }
...
//            $message->to('mihaelamicu.stoian@gmail.com')->subject('Serviciu solicitat din aplicatie');
            $message->to('vctr.dumitru@gmail.com')->subject('Serviciu de infiintare/mentinue/radiere companie solicitat din aplicatie');
        });
    }
...
//            $message->to('mihaelamicu.stoian@gmail.com')->subject('Serviciu solicitat din aplicatie');
            $message->to('vctr.dumitru@gmail.com')->subject('Contact');
        });
    }
}
