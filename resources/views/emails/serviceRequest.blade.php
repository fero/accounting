...
<div style="margin-bottom: 10px">
    <div style="display: inline-block; width: 200px;">
        <strong>Înregistrat în scopuri de TVA</strong>
    </div>
    <div style="display: inline-block; padding-left: 20px;">{{ $vat or '' }}</div>
</div>

<div style="margin-bottom: 10px">
    <div style="display: inline-block; width: 200px;">
        <strong>Număr mediu lunar acte de cumparare primite</strong>
    </div>
    <div style="display: inline-block; padding-left: 20px;">{{ $papersReceived or '' }}</div>
</div>

<div style="margin-bottom: 10px">
    <div style="display: inline-block; width: 200px;">
        <strong>Număr mediu lunar acte de vânzare emise</strong>
    </div>
    <div style="display: inline-block; padding-left: 20px;">{{ $papersSent or '' }}</div>
</div>
