...
@section('content')
        ...
        <div id="main-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="img/images/stock-photo-141869253.jpg" alt="...">
    ...
    <div class="content">
        ...
        <p>Ca și politică de preț, suntem o echipă de experți contabili care își construiește tarifele în funcție de volumul lucrărilor, complexitatea lucrărilor și modul de colaborare cu clienții.</p>

        <p>Pentru a primi o cotație de preț pentru serviciile de expert contabil vă invităm să folosiți formularul de mai jos. În maxim 24 de ore, zile lucrătoare, veți fi contactat de către un membru al echipei noastre și veți primi informațiile solicitate.</p>
    </div>
