...
@section('content')
        ...
        <div id="main-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="img/images/stock-photo-129947359.jpg" alt="...">
    ...
    <div class="content">
        ...
        <p>Serviciul nostru de modificare firmă și mențiuni este centrat pe următoarele forme de înregistrare: persoană fizică autorizată (PFA), întreprindere individuală (II), întreprindere familială (IF), societate cu răspundere limitată (SRL) sau organizație non-guvernamentală (ONG).</p>

        <p>Serviciul este disponibil pentru realizarea de mențiuni în orice județ al țării mulțumită comunicării online și folosirii semnăturii electronice.</p>
