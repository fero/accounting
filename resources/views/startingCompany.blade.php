...
@section('content')
        ...
        <div id="main-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="img/images/stock-photo-110150907_2.jpg" alt="...">
    ...
    <div class="content">
        <h2>Înființare firmă – SRL, PFA, II, IF (înmatriculare) la Registrul Comerțului din orice județ</h2>

        <p>Serviciul nostru de înființare firmă și înmatriculări este centrat pe următoarele forme de înregistrare: persoană fizică autorizată (PFA), întreprindere individuală (II), întreprindere familială (IF), societate cu răspundere limitată (SRL) sau organizație non-guvernamentală (ONG).</p>

        <p>Serviciul este disponibil pentru realizarea de înmatriculări în orice județ al țării mulțumită comunicării online și folosirii semnăturii electronice.</p>

        <p>Clienții beneficiază de consultanță cu privire la cea mai adecvată formă de înregistrare, evită deplasările și drumurile inutile și cozile de la birourile Oficiului Național al Registrului Comerțului.</p>
